...
@Destination(
    deepLinks = [
        DeepLink(
            uriPattern = "be://oneOffRound/$FULL_ROUTE_PLACEHOLDER"
        )
    ]
)
@Composable
fun OneOffRoundScreen(navigator: DestinationsNavigator,
                      navBackStackEntry: NavBackStackEntry,
                      viewModel: OneOffRoundViewModel = hiltViewModel(),
                      oneOffRound: OneOffRound
)
{
