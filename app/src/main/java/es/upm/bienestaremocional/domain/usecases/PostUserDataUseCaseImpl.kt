...
import es.upm.bienestaremocional.data.remote.senders.DistanceSender
import es.upm.bienestaremocional.data.remote.senders.DistanceSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.ElevationGainedSender
import es.upm.bienestaremocional.data.remote.senders.ElevationGainedSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.ExerciseSessionSender
import es.upm.bienestaremocional.data.remote.senders.ExerciseSessionSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.FloorsClimbedSender
import es.upm.bienestaremocional.data.remote.senders.FloorsClimbedSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.HeartRateSender
import es.upm.bienestaremocional.data.remote.senders.HeartRateSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.SleepSender
import es.upm.bienestaremocional.data.remote.senders.SleepSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.StepsSender
import es.upm.bienestaremocional.data.remote.senders.StepsSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.TotalCaloriesBurnedSender
import es.upm.bienestaremocional.data.remote.senders.TotalCaloriesBurnedSender.Companion.toSender
import es.upm.bienestaremocional.data.remote.senders.WeightSender
import es.upm.bienestaremocional.data.remote.senders.WeightSender.Companion.toSender
