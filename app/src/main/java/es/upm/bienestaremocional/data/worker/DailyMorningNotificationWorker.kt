...
@HiltWorker
class DailyMorningNotificationWorker @AssistedInject constructor(
...
): CoroutineWorker(appContext, workerParams)
{
    companion object : Schedulable {
        ...
        override val tag: String = "morning_notification"
    ...
    override suspend fun doWork(): Result
    {
        ...
        val dailyRound = insertDailyRoundUseCase.insertDailyMorningRound()

        notification.showDailyMorningRoundNotification(dailyRound)
